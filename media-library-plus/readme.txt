...
== Changelog ==
= 8.4.2 =
* Improved security and reliability of media URL updates for SiteOrigin and Elementor content.
* Maintained compatibility with existing Elementor content when updating media URLs.

= 8.4.1 =
* Fixed upload validation to enforce WordPress file-type restrictions and user permissions.
* Improved handling of corrected upload filenames and invalid-file messages.

= 8.4.0 =
* Improved admin notice handling with additional permission checks and request validation.
* Updated notice redirects for more reliable navigation.

= 8.3.9 =
* Fixed false directory traversal detection when uploads paths use symlinked directories, such as Bitnami/AWS Lightsail installs.
* Improved path validation to compare resolved filesystem paths and require exact directory matches or true child paths.
* Strengthened protected file path checks to avoid sibling-prefix matches.
* Updated attachment path lookup to support symlinked uploads directories safely.
* Updated the upgrade to pro page
* Tested with Wordpress 7.1

= 8.3.8 =
* Fixed integration issues with the Elementor plugin
